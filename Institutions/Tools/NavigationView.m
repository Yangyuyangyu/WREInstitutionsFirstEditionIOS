...
{
    self = [super initWithFrame:CGRectMake(0, 0, XN_WIDTH, 64)];
    if (self) {
        self.title = title;
...
{
    self.backgroundColor = XN_COLOR_RED_MINT;
...
- (UILabel *)titleLabel
{
    if (!_titleLabel) {
        ...
        _titleLabel.center = CGPointMake(XN_WIDTH/2, 45);
    }
    return _titleLabel;
}
...
- (UIButton *)leftButton
{
    if (!_leftButton) {
        ...
        _leftButton.center = CGPointMake(20, 45);
