...
//    self.tabBarController.tabBar.translucent = true;
    ...
    [_management newsDetailInfoList:_ID];
...
- (void)webViewDidFinishLoad:(UIWebView *)webView{
    ...
    _content.frame = CGRectMake(0, 240, _headtable.bounds.size.width, clientheight);
    _headtable.contentSize=CGSizeMake(64, clientheight + _headView.bounds.size.height - 115);
}
